<?php namespace App\Http\Controllers;
	...
	class AdminJobsController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form = [];
			$this->form[] = ['label'=>'Category','name'=>'categories_id','type'=>'select2','validation'=>'required|integer|min:0','width'=>'col-sm-10','datatable'=>'categories,name'];
			$this->form[] = ['label'=>'Job Title','name'=>'titles_id','type'=>'select','width'=>'col-sm-10','datatable'=>'titles,name','parent_select'=>'categories_id'];
			$this->form[] = ['label'=>'City','name'=>'cities_id','type'=>'select2','validation'=>'required|integer|min:0','width'=>'col-sm-10','datatable'=>'cities,name'];
			$this->form[] = ['label'=>'Company','name'=>'companies_id','type'=>'select2','validation'=>'required|integer|min:0','width'=>'col-sm-10','datatable'=>'companies,name'];
			$this->form[] = ['label'=>'Nature','name'=>'natures_id','type'=>'select2','validation'=>'required|integer|min:0','width'=>'col-sm-10','datatable'=>'natures,name'];
			$this->form[] = ['label'=>'Gender','name'=>'gender','type'=>'select','validation'=>'required|min:1|max:255','width'=>'col-sm-10','dataenum'=>'Male;Female; Male & Female'];
	        ...
	        */
			...
			$this->sub_module[] = ['label'=>'Candicates',
			'path'=>'jobs_users',
			'foreign_key'=>'jobs_id',
			'button_color'=>'success','button_icon'=>'fa fa-users'];
	    ...
	    */
		...
		public function getSetStatus($status,$id) {
			...
			CRUDBooster::redirect($_SERVER['HTTP_REFERER'],"The status job  has been updated !","info");
		 }
