                ...
                <div class="col-lg-3 col-md-12 col-sm-12 col-12 d-none d-sm-none d-md-none d-lg-block d-xl-block">
                    <div class="job_filter_category_sidebar jb_cover">
                        ...
                        @foreach (App\Category::all()  as $category )
                                    <p class="job_field">
                                <a href="{{ route('category.index', $category->id ) }}"><label for="c1">{{ $category->name }}<span> ({{ $category->jobs->count() }})</span></label></a>
                            </p>
                        @endforeach
                    ...
                    <div class="job_filter_category_sidebar jb_cover">
                        ...
                        @foreach (App\City::all() as $city)
                                <p class="job_field">
                             <a href="{{ route('city.index', $city->id ) }}">   <label for="c01">Jobs in {{ $city->name }}
